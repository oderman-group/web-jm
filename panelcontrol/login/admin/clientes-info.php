						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								if($_GET["a"]==1){
									...
									$consulta = mysqli_query($conexion,"SELECT cli_id, cli_nombre, cli_descripcion, cli_imagen FROM clientes;");
									$n = mysqli_num_rows($consulta);
								}	
								elseif($_GET["a"]==2){
									echo '<input type="hidden" name="id" value="31">';
									echo '<input type="hidden" name="idR" value="'.$_GET["idR"].'">';
									$consulta = mysqli_query($conexion,"SELECT cli_id, cli_nombre, cli_descripcion, cli_imagen FROM clientes WHERE cli_id='".$_GET["idR"]."'");
								...
								?>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<textarea class="span12 ckeditor m-wrap" name="descripcion" rows="6"><?=$resultado["cli_descripcion"];?></textarea>
										</div>
									</div>
                                    <div class="control-group">
										<label class="control-label">Imagen<br>
                                        Medidas:(160 x 100) - Peso: (2 MB M&aacute;ximo)</label>
										<div class="controls">
