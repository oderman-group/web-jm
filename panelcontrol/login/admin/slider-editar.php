					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
                                ...
                                <?php
								$rslider=mysqli_fetch_array(mysqli_query($conexion,"SELECT * FROM slider WHERE sli_id=".$_GET["id"].";"));
								...
								?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" class="span6 m-wrap" value="<?=$rslider["sli_titulo"]?>" name="tituloP"/>
										</div>
									</div>

									<div class="control-group">
										<label class="control-label">Texto corto</label>
										<div class="controls">
											<input type="text" class="span6 m-wrap" value="<?=$rslider["sli_texto_corto"]?>" name="textoCorto"/>
										</div>
									</div>
                                    ...
                                    <div class="control-group">
										<label class="control-label">Imágen<br>
                                        Medidas:(1920 X 800) - Peso: (1 MB M&aacute;ximo)</label>
										<div class="controls">
                                  ...
                                  <div class="control-group">
									...
									<div class="control-group">
										<label class="control-label">Nombre del Botón</label>
										<div class="controls">
											<input type="text" class="span6 m-wrap" value="<?=$rslider["sli_boton"]?>" name="boton"/>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" class="span6 m-wrap" value="<?=$rslider["sli_url"]?>" name="url"/>
										</div>
									</div>
