				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="productos-fotos.php?prod=<?=$_GET["prod"];?>">Fotos Productos</a>
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								elseif($_GET["a"]==2){
									...
									$consulta = mysqli_query($conexion,"SELECT * FROM " . $bdJM . ".gw_img_prod WHERE img_id='".$_GET["idR"]."'");
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<div class="fileupload fileupload-new" data-provides="fileupload">
                                                ...
                                                <?php if(!empty($resultado["img_imagen"])){?>
                                                <img src="../../../imagenes/productos/<?=$resultado["img_imagen"]?>" alt="" />
												<?php }else{?>
