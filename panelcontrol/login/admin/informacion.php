						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
                                ...
                                <?php
									...
									$consulta = mysqli_query($conexion,"SELECT * FROM informacion WHERE info_id=1");
								...
								?>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<input type="text" class="span12 m-wrap" name="mapa" value="<?=$resultado[11];?>"/><br>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
                                          <input id="tags_1" type="text"  name="emails" class="tags span6" value="<?=$resultado["info_emails"];?>"/>
									  </div>
									</div>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
                                          <input id="tags_2" type="text" name="telefonos" class="tags span6" value="<?=$resultado["info_telefonos"];?>"/>
										</div>
									</div>
