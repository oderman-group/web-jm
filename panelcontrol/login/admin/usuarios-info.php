						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								elseif($_GET["a"]==2){
									...
									$consulta = mysqli_query($conexion,"SELECT * FROM usuarios WHERE usr_id='".$_GET["idR"]."'");
								...
								?>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<input type="text" class="span4 m-wrap" name="nombre" value="<?php if(!empty($resultado["usr_nombre"])){ echo $resultado["usr_nombre"];}?>" style="text-transform:uppercase;" />
										</div>
									</div>
                                    <div class="control-group">
									  <label class="control-label">Email</label>
										<div class="controls">
											<input type="email" class="span4 m-wrap" name="email" value="<?php if(!empty($resultado["usr_email"])){ echo $resultado["usr_email"];}?>"  style="text-transform:lowercase;"/>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" class="span4 m-wrap" name="cargo" value="<?php if(!empty($resultado["usr_cargo"])){ echo $resultado["usr_cargo"];}?>" />
										</div>
									</div>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
                                            <select data-placeholder="Your Favorite Football Team" class="chosen span4" tabindex="-1" name="estado">
												...
												<option value="1" <?php if(!empty($resultado["usr_activo"]) && $resultado["usr_activo"]==1){echo "selected";}?>>Activo</option>
												<option value="2" <?php if(!empty($resultado["usr_activo"]) && $resultado["usr_activo"]==2){echo "selected";}?>>Inactivo</option>
											</select>
										</div>
									</div>
