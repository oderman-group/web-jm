						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								elseif($_GET["a"]==2){
									...
									$consulta = mysqli_query($conexion,"SELECT * FROM " . $bdJM . ".gw_supcategorias WHERE sup_id=".$_GET["id"].";");
								...
								?>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
											<input class="span10 m-wrap" name="titulo" value="<?php if(!empty($resultado["sup_nombre"])){ echo $resultado["sup_nombre"];}?>">
										</div>
									</div>


									<div class="control-group">
										<label class="control-label">Banner<br>
                                        Medidas:(1280 x 266) - Peso: (1 MB M&aacute;ximo)</label>
										<div class="controls">
											<div class="fileupload fileupload-new" data-provides="fileupload">
												<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                <?php if(!empty($resultado["sup_banner"])){?>
                                                <img src="../../../banner_productos/<?=$resultado["sup_banner"]?>" alt="" />
												<?php }else{?>
