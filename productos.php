...
$dato = mysqli_fetch_array(mysqli_query($conexion,"SELECT * FROM gw_prod_categorias INNER JOIN gw_supcategorias ON sup_id=catep_id_supercat WHERE catep_id='".$_GET["cat"]."'"));

$filtroCat = '';
if(!empty($_GET["cat"])){$filtroCat .= " AND catep_id='".$_GET["cat"]."'";}
$categorias = mysqli_query($conexion,"SELECT * FROM gw_prod_categorias WHERE catep_id=catep_id $filtroCat ORDER BY catep_id_supercat, catep_posicion");
?>
            ...
            <div class="section-full p-t80 p-b50">
                <div class="container">
                    <div class="section-content">
                        ...
                        <!-- TITLE START -->
                        <div class="p-b10">
                            <h2 class="text-uppercase"><?=strtoupper($cat[1]);?></h2>
                        ...
                        <div class="row">
                            ...
                            $productos = mysqli_query($conexion,"SELECT * FROM gw_productos WHERE prod_categoria='".$cat[0]."' $filtro ORDER BY prod_categoria, prod_posicion");
							while($prod = mysqli_fetch_array($productos)){
                            ?>
                        
                        	<!-- COLUMNS 1 -->
                            <div class="col-md-3 col-sm-4 col-xs-6 col-xs-100pc m-b30">
                                <div class="wt-box wt-product-box" style="border:thin; border-style: solid; border-color: darkgray; padding: 5px;">

                                <a href="detalle.php?id=<?=$prod['prop_id'];?>">
                                    <div class="wt-thum-bx">
                                        <img src="imagenes/productos/<?=$prod['prod_img_ppal'];?>" alt="" class="img-portafolio">
                                    ...
                                    <div class="wt-info  text-center">
                                         <div class="p-a10 bg-white">
                                            <h4 class="wt-title">
                                                <a href="detalle.php?id=<?=$prod['prop_id'];?>"><?=$prod['prod_nombre'];?></a>
                                            </h4>
                                            <div class="p-t10">
                                                <a href="detalle.php?id=<?=$prod['prop_id'];?>" class="site-button skew-icon-btn m-r15" type="button">VER DETALLES <i class="fa fa-angle-double-right"></i></a>
                                            </div>
                                         </div>
                                    </div>
                                </div>
